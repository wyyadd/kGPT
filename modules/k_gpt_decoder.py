...
class KGPTDecoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.r_patch_emb = FourierEmbedding(input_dim=5, hidden_dim=hidden_dim,
                                            num_freq_bands=num_freq_bands)
        self.r_t_emb = FourierEmbedding(input_dim=5, hidden_dim=hidden_dim, num_freq_bands=num_freq_bands)

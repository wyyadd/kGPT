    ...
    def test_step(self,
        ...
        for k in range(self.simulation_times):
            for t in range(self.num_rollout_steps // num_action_steps):
                ...
                delta_p = pred['delta_v'][torch.arange(sample_inds.size(0)).unsqueeze(-1), start_steps - 1,
